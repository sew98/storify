...
class GenerateStats extends Command
{
     ...
     * @var string
     */
    protected $signature = 'generate:stats {user?} {--s|Sort=id}'; //calling name - php artisan signature
...
//        $this->info('Generate Stats command has run');
    ...
    //command to - getusers with their story count and email
